...
@interface ISGWebViewController ()<UIWebViewDelegate,UINavigationControllerDelegate,UINavigationBarDelegate,NJKWebViewProgressDelegate>
...
@implementation ISGWebViewController
...
- (void)viewDidLoad {
    ...
    [self ISG_NavigationBarWithTitle:nil];
...
-(UIWebView*)webView{
    if (!_webView) {
        _webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, KSCREEWIDTH, KSCREENHEIGHT-64)];
